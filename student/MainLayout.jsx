		...
		<>
			...
			<View style={style.container}>
				...
				<View style={style.navbar}>
					...
					<TouchableOpacity style={style.navbar.button} onPress={ () => setCurrentPage('home') }>
						<Image 
					...
					<TouchableOpacity style={style.navbar.button} onPress={ () => setCurrentPage('sports') }>
						<Image 
					...
					<TouchableOpacity style={style.navbar.button} onPress={ () => setCurrentPage('events') }>
						<Image 
					...
					<TouchableOpacity style={style.navbar.button} onPress={ () => setCurrentPage('profile') }>
						<Image 
